...
INSERT INTO actors(id,name,age,gender) values(1,'Brad Pitt',40,'Male');
INSERT INTO actors(id,name,age,gender) values(2,'Morgan Freeman',33,'Male');
INSERT INTO actors(id,name,age,gender) values(3,'Robert Downey Jr',50,'Male');
INSERT INTO actors(id,name,age,gender) values(4,'Benedict Cumberbatch',30,'Male');
INSERT INTO actors(id,name,age,gender) values(5,'Will Smith',44,'Male');
INSERT INTO actors(id,name,age,gender) values(6,'Jay Bendict',60,'Male');

actor1 = Actor(name='George cooper',age=40,gender='Male')
